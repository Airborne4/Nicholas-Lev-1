...
frame.setVisible(true);
		...
		frame.setTitle("Java Jeopardy m9");
...
frame.add(quizPanel);
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (buttonPressed==firstButton) {
			askQuestion("What was the battle against the first Death Star called?", "Battle of Yavin", 500);
		}
...
if (buttonPressed==secondButton) {
	askQuestion("What alien creature is commonly used for transportation on Hoth?", "Taun Taun", 200);
}
